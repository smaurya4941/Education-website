...
Auth::routes(['verify' => true, 'register' => false]); //routes for authentication except regiter
...
Route::get(
    'pricing',
    function () {
        $plans = \App\Models\Plan::orderBy('amount', 'ASC')->with('salaryCurrency')->get();
        return view('front_web.pricing.index', compact('plans'));
    }
)->name('pricing');
