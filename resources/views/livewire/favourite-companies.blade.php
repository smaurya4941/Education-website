                                                ...
                                                <div class="d-flex job-listing-description ">
                                                    ...
                                                    <div class="mb-auto w-100 favorite-company-data favourite-companies-data">
                                                        <h4 class="job-listing-favorite-company d-inline-flex mb-2">
                                                            {{ (!empty($favouriteCompany->company->user->first_name)) ? $favouriteCompany->company->user->first_name : __('messages.n/a')  }}
                                                        </h4>
                                                        <h3 class="job-listing-title-favorite-company margin-bottom-5">
                                                            <i class="fas fa-phone-alt"></i>
                                                            {{ (!empty($favouriteCompany->company->user->phone)) ? '+'.$favouriteCompany->company->user->region_code.' '.$favouriteCompany->company->user->phone  : __('messages.n/a') }}
                                                        </h3>
                                                        <h3 class="job-listing-title-favorite-company margin-bottom-5">
                                                            <i class="fas fa-envelope"></i>
                                                            <span data-toggle="tooltip" data-placement="bottom"
                                                                  title="{{$favouriteCompany->company->user->email}}">
                                            {{ (!empty($favouriteCompany->company->user->email)) ? Str::limit($favouriteCompany->company->user->email, 20) : __('messages.n/a')}}</span>
                                                        </h3>
                                                        <h3 class="job-listing-title-favorite-company favourite-companies-margin mb-5 two-line-ellip">
                                                            <i class="fas fa-industry"></i> {{ (!empty($favouriteCompany->company->industry->name)) ? $favouriteCompany->company->industry->name : __('messages.n/a') }}
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
