...
<div class="bw-auth-container">
    <div class="bw-auth-card">
        ...
        <div class="bw-auth-tabs">
            <a href="{{ route('front.candidate.login') }}" class="bw-auth-tab">{{ __('web.register_menu.candidate') }}</a>
            <a href="{{ route('front.employee.login') }}" class="bw-auth-tab active">{{ __('web.register_menu.employer') }}</a>
        </div>
        ...
        <form method="POST" action="{{ route('front.login') }}" id="employeeForm">
            ...
            <div class="text-center mb-4" style="font-size: 14px; color: #6c6a77;">
                ...
                <a href="{{ route('employer.register') }}" class="bw-forgot-link" style="font-weight: 700;">{{ __('web.sign_up') }}</a>
            </div>
