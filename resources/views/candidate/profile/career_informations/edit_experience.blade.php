...
<div class="row">
    ...
    <div class="col-sm-6 mb-5">
        {{ Form::label('institution_type', 'Institution type:', ['class' => 'form-label ']) }}
        ...
        ], null, ['class' => 'form-select', 'id' => 'editInstitutionType', 'placeholder' => 'Select']) }}
    </div>
    <div class="col-sm-6 mb-5">
    ...
    <div class="col-sm-6 mb-5">
        ...
        <input type="text" name="end_date" id="editEndDate"
               class="form-control {{(getLoggedInUser()->theme_mode) ? 'bg-light' : 'bg-white'}}" autocomplete="off"
