        ...
        <div class="col-md-12 mt-5 shadow p-9 card">
            ...
            <div class="border-bottom border-danger my-5 border-2 d-flex justify-content-between ">
                <h5 class="mt-2 fs-2 text-info"><i
                        class="fas fa-user-graduate text-info p-3 border rounded-circle border-info {{ checkLanguageSession() == 'ar' ? 'ms-3' : 'me-3' }}"></i>{{ __('messages.candidate_profile.education') }}
                </h5>
            ...
            <div class="border-bottom my-5 border-danger border-2 d-flex justify-content-between">
                <h5 class="mt-2 fs-2 text-info"><i
                        class="fas fa-briefcase text-info p-3 border rounded-circle border-info {{ checkLanguageSession() == 'ar' ? 'ms-3' : 'me-3' }}"></i>{{ __('messages.candidate_profile.experience') }}
                </h5>
            ...
            <div class="border-bottom my-5 border-danger border-2 d-flex justify-content-between">
                <h5 class="mt-2 fs-2 text-info"><i
                        class="fas fa-link text-info p-3 border rounded-circle border-info {{ checkLanguageSession() == 'ar' ? 'ms-3' : 'me-3' }}"></i>{{ __('messages.candidate_profile.online_profile') }}
                </h5>
