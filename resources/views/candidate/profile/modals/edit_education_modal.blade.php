        ...
        <div class="modal-content border-0 rounded-[24px] shadow-[0_12px_40px_rgba(161,0,255,0.15)] bg-white overflow-hidden">
            <div class="modal-header border-b border-[#ede8f5] bg-[#faf7ff] px-8 py-5">
                <h3 class="modal-title text-[22px] font-bold text-[#1b1c1c] font-['Plus_Jakarta_Sans'] m-0 flex items-center gap-3">
                    ...
                    {{  __('messages.candidate_profile.edit_education') }}
                </h3>
            ...
            {{ Form::open(['id'=>'editCareerEducationForm', 'class' => 'm-0']) }}
            <div class="modal-body px-8 py-6 bg-white">
                ...
                <div class="row">
                    <div class="col-sm-6 mb-5">
                        ...
                        {{ Form::select('degree_level_id', $data['degreeLevels'], null ,['class' => 'form-select !rounded-xl !border-[#ede8f5] focus:!border-[#a100ff] focus:!ring-[#a100ff] !text-[#1b1c1c] !bg-white px-4 py-3 shadow-sm transition-all','required','id' => 'editDegreeLevel']) }}
                    </div>

                    <div class="col-sm-6 mb-5">
                        {{ Form::label('degree_title', 'Specialisation:', ['class' => 'form-label text-[#4e4256] font-bold text-[14px] mb-2']) }}
                        <span class="required text-red-500">*</span>
                        {{ Form::text('degree_title', null, ['class' => 'form-control !rounded-xl !border-[#ede8f5] focus:!border-[#a100ff] focus:!ring-[#a100ff] !text-[#1b1c1c] !bg-white px-4 py-3 shadow-sm transition-all','required','id'=>'editDegreeTitle','placeholder'=>'Mathematics, English Literature']) }}
                    </div>
                    <div class="col-sm-6 mb-5">
                        {{ Form::label('institute', 'University / institution:', ['class' => 'form-label text-[#4e4256] font-bold text-[14px] mb-2']) }}
                        {{ Form::text('institute', null,['class' => 'form-control !rounded-xl !border-[#ede8f5] focus:!border-[#a100ff] focus:!ring-[#a100ff] !text-[#1b1c1c] !bg-white px-4 py-3 shadow-sm transition-all','id'=>'editInstitute','placeholder'=>'Delhi University']) }}
                    </div>
                    <div class="col-sm-6 mb-5">
                        {{ Form::label('year', 'Year of completion:', ['class' => 'form-label text-[#4e4256] font-bold text-[14px] mb-2']) }}
                        {{ Form::selectRange('year', date('Y') + 1, 1970, null, ['class' => 'form-select !rounded-xl !border-[#ede8f5] focus:!border-[#a100ff] focus:!ring-[#a100ff] !text-[#1b1c1c] !bg-white px-4 py-3 shadow-sm transition-all','placeholder' => 'Select year','id' => 'editYear'])}}
