        ...
        <div class="modal-content border-0 rounded-[24px] shadow-[0_12px_40px_rgba(161,0,255,0.15)] bg-white overflow-hidden">
            <div class="modal-header border-b border-[#ede8f5] bg-[#faf7ff] px-8 py-5">
                <h3 class="modal-title text-[22px] font-bold text-[#1b1c1c] font-['Plus_Jakarta_Sans'] m-0 flex items-center gap-3">
                    ...
                    {{ __('messages.candidate_profile.add_experience') }}
                </h3>
            ...
            {{ Form::open(['id'=>'addNewExperienceForm', 'class' => 'm-0']) }}
            <div class="modal-body px-8 py-6 bg-white">
                ...
                <div class="row">
                    <div class="col-sm-6 mb-5">
                        ...
                        {{ Form::text('experience_title', null, ['class' => 'form-control !rounded-xl !border-[#ede8f5] focus:!border-[#a100ff] focus:!ring-[#a100ff] !text-[#1b1c1c] !bg-white px-4 py-3 shadow-sm transition-all','required', 'placeholder'=>__('messages.candidate_profile.experience_title')]) }}
                    </div>
                    <div class="col-sm-6 mb-5">
                        {{ Form::label('company',__('messages.candidate_profile.company').(':'),['class' => 'form-label text-[#4e4256] font-bold text-[14px] mb-2']) }}
                        <span class="required text-red-500">*</span>
                        {{ Form::text('company', null, ['class' => 'form-control !rounded-xl !border-[#ede8f5] focus:!border-[#a100ff] focus:!ring-[#a100ff] !text-[#1b1c1c] !bg-white px-4 py-3 shadow-sm transition-all','required', 'placeholder'=>__('messages.candidate_profile.company')]) }}
                    </div>
                    <div class="col-sm-6 mb-5">
                        ...
                        ], null, ['class' => 'form-select !rounded-xl !border-[#ede8f5] focus:!border-[#a100ff] focus:!ring-[#a100ff] !text-[#1b1c1c] !bg-white px-4 py-3 shadow-sm transition-all', 'placeholder' => 'Select']) }}
                    </div>
                    <div class="col-sm-6 mb-5">
                        {{ Form::label('country', __('messages.company.country').(':'),['class' => 'form-label text-[#4e4256] font-bold text-[14px] mb-2']) }}
                        <span class="required text-red-500">*</span>
                        {{ Form::select('country_id',$data['countries'], null, ['id'=>'countryId','class' => 'form-select !rounded-xl !border-[#ede8f5] focus:!border-[#a100ff] focus:!ring-[#a100ff] !text-[#1b1c1c] !bg-white px-4 py-3 shadow-sm transition-all','placeholder' => __('messages.company.select_country'),'data-modal-type' => 'experience','required']) }}
                    </div>
                    <div class="col-sm-6 mb-5">
                        {{ Form::label('state', __('messages.company.state').(':'),['class' => 'form-label text-[#4e4256] font-bold text-[14px] mb-2']) }}
                        {{ Form::select('state_id', [], null, ['id'=>'stateId','class' => 'form-select !rounded-xl !border-[#ede8f5] focus:!border-[#a100ff] focus:!ring-[#a100ff] !text-[#1b1c1c] !bg-white px-4 py-3 shadow-sm transition-all','placeholder' => __('messages.company.select_state'), 'data-modal-type' => 'experience']) }}
                    </div>
                    <div class="col-sm-6 mb-5">
                        {{ Form::label('city', __('messages.company.city').(':'),['class' => 'form-label text-[#4e4256] font-bold text-[14px] mb-2']) }}
                        {{ Form::select('city_id', [], null, ['class' => 'form-select !rounded-xl !border-[#ede8f5] focus:!border-[#a100ff] focus:!ring-[#a100ff] !text-[#1b1c1c] !bg-white px-4 py-3 shadow-sm transition-all','id'=>'cityId','placeholder' => __('messages.company.select_city')]) }}
                    </div>
                    <div class="col-sm-6 mb-5">
                        ...
                        <input type="text" name="start_date" id="startDateExperience"
                               class="form-control !rounded-xl !border-[#ede8f5] focus:!border-[#a100ff] focus:!ring-[#a100ff] !text-[#1b1c1c] !bg-white px-4 py-3 shadow-sm transition-all"
                    ...
                    <div class="col-sm-6 mb-5">
                        ...
                        <div class="form-check form-switch mt-2">
                            <input class="form-check-input focus:!ring-[#a100ff] focus:!border-[#a100ff] checked:!bg-[#a100ff] checked:!border-[#a100ff] {{ checkLanguageSession() == 'ar' ? 'float-end' : '' }}" name="currently_working" type="checkbox" value="1" id="default">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        {{ Form::label('description', __('messages.candidate_profile.description').':', ['class' => 'form-label text-[#4e4256] font-bold text-[14px] mb-2']) }}
                        {{ Form::textarea('description',null, ['class' => 'form-control !rounded-xl !border-[#ede8f5] focus:!border-[#a100ff] focus:!ring-[#a100ff] !text-[#1b1c1c] !bg-white px-4 py-3 shadow-sm transition-all','rows'=>'4','placeholder'=>__('messages.candidate_profile.description')]) }}
                    </div>
                </div>
            </div>
