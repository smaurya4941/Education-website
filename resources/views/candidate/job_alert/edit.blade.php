    ...
    <div class="card">
        <div class="card-body">
            ...
            <div
                ...
                <span class="mt-2 fs-6 text-gray-600 {{ checkLanguageSession() == 'ar' ? 'me-15' : '' }}">{{ __('messages.candidate.job_alert_message') }}</span>
            </div>
            <div class="form-group {{ checkLanguageSession() == 'ar' ? 'me-19' : 'ms-19' }}">
                <div class="custom-switches-stacked">
                    @foreach($jobTypes as $jobType)
                        <div class="col-lg-12 col-md-6 mb-2 d-flex justify-content-start form-check form-switch">
                            ...
                            <span
                                class="mt-2 fs-6 text-gray-600 {{ checkLanguageSession() == 'ar' ? 'me-15' : '' }}">{{ htmlspecialchars_decode($jobType->name) }}</span>
                        </div>
                    @endforeach
                </div>
            </div>
