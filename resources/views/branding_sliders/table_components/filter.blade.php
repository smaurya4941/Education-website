             ...
             <div class="dropdown-menu py-0" aria-labelledby="brandingSliderBtn">
                 ...
                 <div class="p-5">
                       <div class="mb-5">
                                ...
                                {{ Form::select('status',getTranslatedData(collect($filterHeads[0])->sortBy('key')->toArray()),null,['class' => 'form-select io-select2', 'data-control' => 'select2', 'id' => 'brandingSlider']) }}
                       </div>
